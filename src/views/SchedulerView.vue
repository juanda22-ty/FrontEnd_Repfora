<template>
  <q-layout view="hHh Lpr lFf">
    ...
    >
      ...
      >
        <q-card-section
          class="bg-green-10 text-white q-py-md text-subtitle2 text-weight-bolder text-uppercase"
        >
            ...
            >
              <q-card-section class="q-pa-xl">
                ...
                <div class="text-h5 text-weight-bolder text-green-10">
                  Módulo de Coordinador y Programador
                </div>
                <div
                  class="text-subtitle1 text-grey-6 q-mt-sm"
                  style="max-width: 500px; margin-inline: auto"
                >
                  Selecciona una ficha de la barra lateral izquierda para
                  comenzar a validar y confirmar la programación de los
                  instructores.
                </div>
              </q-card-section>
            </q-card>
