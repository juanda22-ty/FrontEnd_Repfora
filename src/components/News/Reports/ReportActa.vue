<template>
  <div class="col-12 row">
    ...
    <div class="col-6 flex" v-if="props.dataReport.showDialog == false">
      <q-btn
        type="button"
      ...
      <q-btn
        ...
        @click="props.generateExcel('acta',name)"
        color="green-8"
        ><span
          class="material-symbols-outlined q-mr-sm"
          style="font-size: 22px"
      ...
      <q-btn
        ...
        type="button"
        class="q-mt-md q-mb-sm"
        @click="props.generatePdf('acta',name)"
        color="red-8"
        ><span
          class="material-symbols-outlined q-mr-sm"
          style="font-size: 22px"
          ...
          <q-td :props="datatable">
            <div>
              <q-btn
                ...
                size="xs"
                color="green-10"
                @click="props.generateExcel('acta',name, datatable.row)"
              >
              ...
              <q-btn
                ...
                size="xs"
                color="red-8"
                @click="props.generatePdf('acta',name, datatable.row)"
              >
...
let rows = ref(props.dataReport.dataActa);
let name = ref(
  `   Acta # ${props.form.acta}`
);
//eliminar \n de la variable name
