  ...
  <div class="col-12 row">
    ...
    <div class="col-5 flex" v-if="props.dataReport.showDialog == false">
      ...
      <q-btn
        ...
        @click="props.generateExcel('tpnew',name)"
        color="green-8"
        ><span
          class="material-symbols-outlined q-mr-sm"
          style="font-size: 22px"
      ...
      <q-btn
        ...
        type="button"
        class="q-mt-md q-mb-sm"
        @click="props.generatePdf('tpnew',name)"
        color="red-8"
        ><span
          class="material-symbols-outlined q-mr-sm"
          style="font-size: 22px"
          ...
          <q-td :props="datatable">
            <div>
              <q-btn
                ...
                size="xs"
                color="green-10"
                @click="props.generateExcel('tpnew',name, datatable.row)"
              >
              ...
              <q-btn
                ...
                size="xs"
                color="red-8"
                @click="props.generatePdf('tpnew',name, datatable.row)"
              >
...
let rows = ref(props.dataReport.dataTpNew);
let name = ref(
`
${
  props.form.tpNew.value == "TODOS"
    ? "TODAS LAS NOVEDADES"
    : props.form.tpNew.label
} - ${
  props.form.coordination.value == "TODAS"
    ? "TODAS LAS COORDINACIONES "
    : props.form.coordination.label
}
...
if (props.form.tpNew.value == "TODOS" || props.form.tpNew.value == "TRASLADO") {
  columns.value.push({
    name: "subtpnew",
    label: "SUB NOVEDAD",
    field: (row) => {
