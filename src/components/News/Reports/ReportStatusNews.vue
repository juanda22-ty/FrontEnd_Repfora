  ...
  <div class="col-12 row">
    ...
    <div class="col-5 flex" v-if="props.dataReport.showDialog == false">
      ...
      <q-btn
        ...
        @click="props.generateExcel('state',name)"
        color="green-8"
        ><span
          class="material-symbols-outlined q-mr-sm"
          style="font-size: 22px"
      ...
      <q-btn
        ...
        type="button"
        class="q-mt-md q-mb-sm"
        @click="props.generatePdf('state',name)"
        color="red-8"
        ><span
          class="material-symbols-outlined q-mr-sm"
          style="font-size: 22px"
          ...
          <q-td :props="datatable">
            <div>
              <q-btn
                ...
                size="xs"
                color="green-10"
                @click="props.generateExcel('state',name, datatable.row)"
              >
              ...
              <q-btn
                ...
                size="xs"
                color="red-8"
                @click="props.generatePdf('state',name, datatable.row)"
              >
...
let rows = ref(props.dataReport.dataStateNews);
let name = ref(
  props.form.stateNew == "TODOS"
    ? "TODAS LAS NOVEDADES"
    : `NOVEDADES ${props.form.stateNew}`
);
//eliminar \n de la variable name
